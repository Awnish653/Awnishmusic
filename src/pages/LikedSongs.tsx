  ...
  return (
    <div className="p-4 sm:p-8 space-y-8 max-w-7xl mx-auto pb-32 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-end p-6 md:p-8 rounded-3xl bg-gradient-to-b from-rose-950/40 via-zinc-900/60 to-zinc-900/30 border border-white/10 shadow-2xl">
        <div className="w-48 h-48 sm:w-56 sm:h-56 rounded-2xl bg-gradient-to-tr from-rose-600 to-violet-600 flex items-center justify-center text-white shadow-2xl shrink-0 ring-1 ring-white/15">
        ...
        <div className="flex flex-col space-y-3 text-center md:text-left flex-1 min-w-0">
          <span className="text-xs uppercase font-black text-rose-400 tracking-wider">
            Your Collection
          </span>
          ...
          <div className="flex items-center justify-center md:justify-start gap-3 pt-2">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-rose-600 to-violet-600 hover:from-rose-500 hover:to-violet-500 text-white font-bold text-sm shadow-xl shadow-rose-600/30 transition hover:scale-105 active:scale-95 disabled:opacity-50"
            >
        ...
        <EmptyState
          ...
          action={
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs shadow transition"
            >
              Discover Songs
            </button>
          }
